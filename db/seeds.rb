...
gp.meta_data.build({:key => '_goal_color', :value => 'blue'})
...
gp.meta_data.build({:key => '_goal_color', :value => 'red'})
...
gp.meta_data.build({:key => '_goal_color', :value => 'green'})
...
gp.meta_data.build({:key => '_goal_color', :value => 'purple'})
gp = l.game_pieces.build({:cell => '4,4', :piece_type => 'game-piece', :piece => 'fixed'})
gp.meta_data.build({:key => 'class', :value => 'fixed'})
...
gp.meta_data.build({:key => '_goal_color', :value => 'orange'})
